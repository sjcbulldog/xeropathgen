...
{
public:
	CheesyGenerator(double diststep, double maxdx, double maxdy, double maxtheta);
...
private:
	...
	std::vector<xero::paths::Pose2dWithTrajectory> timeParameterize(const xero::paths::DistanceView& view);
