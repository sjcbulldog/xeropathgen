...
private:
	...
	static bool readMarkers(QFile& file, std::shared_ptr<xero::paths::RobotPath> path, QJsonArray& group);
	...
	static bool readInteger(QFile& file, QJsonObject& obj, QString obname, QString name, int& value, bool opt = false);
